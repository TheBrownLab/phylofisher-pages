...
[`dataset_to_database.py`](https://thebrownlab.github.io/phylofisher-pages/utilities/dataset-to-database): Convert an existing PhyloFisher database to the new SQLite database format. 
