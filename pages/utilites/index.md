...
[`gfmix_runner.py`](https://thebrownlab.github.io/phylofisher-pages/utilities/gfmix-runner): Runs 
...
[`leaf_renamer.py`](https://thebrownlab.github.io/phylofisher-pages/utilities/leaf-renamer): Renames leaves in phylogenetic trees to match the long names in the PhyloFisher database. This utility converts Unique IDs to full taxonomic names for better readability.
...
[`plot_matrix_completeness.py`](https://thebrownlab.github.io/phylofisher-pages/utilities/plot-matrix-completeness): Generate a bar plot of site-wise and gene-wise matrix completeness for the taxa in the provided matrix file and gene occupancy file. The output helps identify taxa with low data coverage and assess the overall completeness of phylogenomic matrices.
